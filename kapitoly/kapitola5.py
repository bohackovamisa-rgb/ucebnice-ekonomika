...
def render():
    ...
    if selected_section_5.startswith("1."):
        ...
        st.write(
            ...
            " kterém můžeme my všichni svobodně hrát hru jnímem kapitalismus."
        )
    ...
    # =========================================================================
        ...
        col_res1.metric("Peníze na účtu (Nominální)", f"{int(konecna_castka)} Kč")
        col_res2.metric(
            "Skutečná hodnota peněz (Reálná)", f"{int(realna_hodnota)} Kč"
        )
