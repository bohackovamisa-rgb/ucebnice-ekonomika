...
# =========================================================================
# 4. GLOBÁLNÍ DESIGN, ACCESSIBILITY & OPRAVENÁ PLOVOUCÍ SOVA
# =========================================================================
...
div[data-testid="stPopover"] {
    ...
    width: 68px !important;    /* Omezení šířky, aby nevznikla lišta */
    height: 68px !important;   /* Omezení výšky */
    z-index: 999999 !important;
    opacity: 0.5 !important;   /* Poloprůhledná, aby se nepletla do textu */
    transition: opacity 0.3s ease !important;
}

div[data-testid="stPopover"]:hover {
    opacity: 1.0 !important;   /* Po najetí myší se zviditelní plně */
}

div[data-testid="stPopover"] > button {
    background: linear-gradient(135deg, #6366f1, #a855f7, #ec4899) !important;
    color: #ffffff !important;
    border-radius: 50% !important; /* Kulatý tvar */
    width: 100% !important;
...
# =========================================================================
# 🦉 PLOVOUCÍ EKO-SOVA (AI TUTOR CHAT) - FIX ŠÍŘKY
# =========================================================================
...
with st.popover("🦉", use_container_width=False):
    ...
    otazka = st.text_input("Zeptej se mě na cokoliv z ekonomiky:", key="floating_ai_q")
    
    if st.button("Zeptat se", key="btn_sova_ptat_se"):
        if otazka:
            with st.spinner("Sova houká a přemýšlí..."):
                odpoved = ai_tutor_chat(otazka, curr_view_name)
                st.info(odpoved)
        else:
