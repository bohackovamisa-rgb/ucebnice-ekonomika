...
def ai_tutor_chat(otazka_zaka: str, aktualni_kapitola: str):
    try:
        ...
        pass
    return "Húúú! 🦉 Skvělá otázka! Zkus se na to podívat jednoduše: v ekonomice nic není zadarmo."
...
# =========================================================================
# 4. GLOBÁLNÍ DESIGN, ACCESSIBILITY & PLOVOUCÍ SOVA (OPRAVENO)
# =========================================================================
...
/* 🦉 ANIMOVANÁ PLOVOUCÍ SOVA V ROHU (OPRAVENO - BEZ DLOUHÉ LIŠTY) 🦉 */
@keyframes floatSova {
...
def zakovsky_panel():
    ...
    with tab_gamifikace:
        ...
        st.write(f"Celkem máš **{current_xp} XP** z vypracovaných úkolů.")

# Spuštění zobrazení podle stavu
view = st.session_state.get("current_view", "Uvod")
if view == "Uvod":
    st.title("📖 Vítejte v učebnici ekonomiky")
    st.write("Vyberte si kapitolu v bočním panelu nebo pokračujte ve studiu.")
elif view == "Moje_Odpovedi":
    zakovsky_panel()
elif view == "Kapitola 1":
    kapitola1.vykresli()
elif view == "Kapitola 2":
    kapitola2.vykresli()
elif view == "Kapitola 3":
    kapitola3.vykresli()
elif view == "Kapitola 4":
    kapitola4.vykresli()
elif view == "Kapitola 5":
    kapitola5.vykresli()
elif view == "Kapitola 6":
    kapitola6.vykresli()
